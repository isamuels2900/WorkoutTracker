...
from dotenv import load_dotenv # Dotenv is used to store environment variables
...
SECRET_KEY = 'django-insecure-7zpr-+c33%9zefe!0uuk7x397trzqu12^_$z!rp75$k+nq)4v='
